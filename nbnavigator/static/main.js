define([
    ...
    'jquery',
    'exports', 
    './navigator'//Need to add .navigator, and Navigator, that is to be returned from .navigator
], function( Jupyter,
    $,
    exports,
    Navigator) {
    ...
    var navigator_html = $([
        '<div id="nbnavigator" class="tab-pane">',
    ...
    function load_ipython_extension() {
        ...
        $('head').append(
            ...
            .attr('rel', 'stylesheet')
            .attr('type', 'text/css')
            .attr('href', base_url + 'nbextensions/nbnavigator/navigator.css')
        );
        $(".tab-content").append(navigator_html);
        $("#tabs").append(
            $('<li>')
            .append(
                $('<a>')
        ...
        var assignment_list = new Navigator.AssignmentList(
        ...
        var course_list = new Navigator.CourseList(
            '#course_list',
            '#course_list_default',
